...
public class NetworkSendDialog extends PamDialog {
	...
	private MqttNetSendControl networkSender;
	...
	private NetworkSendDialog(Window parentFrame, MqttNetSendControl networkSender) {
	...
	public static NetworkSendParams showDialog(Window frame, MqttNetSendControl networkSender, NetworkSendParams networkSendParams) {
